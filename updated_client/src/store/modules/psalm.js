...
export const actions = {
  ...
  deletePsalm({ commit }, index) {
    ...
    let foundPsalm = state.psalms.find(psalm => psalm.index === index);
    let toDelete = state.psalms.indexOf(foundPsalm);
  ...
  updatePsalm({ commit }, psalm) {
    let index = psalm.index;
    let foundPsalm = state.psalms.find(psalm => psalm.index === index);
    let toUpdate = state.psalms.indexOf(foundPsalm);
